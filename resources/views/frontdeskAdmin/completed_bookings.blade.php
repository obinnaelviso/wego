...
@section('title', 'Dashboard - Completed Bookings')
@section('bookings', 'active')
@section('completed_bookings', 'active')
	...
	<div class="row m-t-75">
	    <div class="col-md-12">
			<div class="user-data m-b-30">
		        <!-- DATA TABLE -->
		        <h3 class="title-3 m-b-40 m-l-40 m-t-40">Completed Bookings</h3>
		        @if(count($bookings))
			                ...
			                <tbody>
			                	@foreach($bookings as $booking)
				                    <tr class="tr-shadow">
				                        ...
				                        <td><i class="text-success">Completed</i></td>
			    ...
			    @else
			    	<div class="alert alert-success m-b-250">
	                	No records available for completed bookings!
	            	</div>
			    @endif
		        <!-- END DATA TABLE -->
		    </div>
